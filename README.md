...
### 마이 페이지
    * 기본적으로 내 닉네임과 도전과제 및 도전뱃지의 내역을 확인할 수 있다.
    * 내 예약리스트를 확인할 수 있다.
...
### 가게 페이지 (제휴 맺은 식당 주인 측)
    ...
    * 예약현황을 통해 내 가게에 대한 총 예약인원, 날짜별 시간에 따른 예약 현황, 각 날짜별 예약 인원 및 잔여 인원 확인이 가능하다.
    * 네비바의 문의를 통해 문의내역 및 문의를 할 수 있다.
    * 가게에 대한 공지사항을 확인할 수 있다.
    * 가게는 문제가 있는 리뷰에 대해서 신고를 할 수 있다.

### *관리자 페이지*

#### *대쉬보드 탭*
    * 관리자는 예약과 관련된 정보를 각종 그래프로 확인 가능하다.
...
#### *리뷰 탭*
    ...
    * 관리자는 가게에서 신고한 리뷰를 상세조회를 통해 이동할 수 있다.
